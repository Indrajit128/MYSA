      ...
      <section className={`section-padding ${styles.howSection}`} id="how">
        ...
        <RevealSection delay="delay-1" className={styles.timeline}>
          {[
            ...
            { step: 'C', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2l3 7 7 3-7 3-3 7-3-7-7-3 7-3z"></path></svg>, title: 'Expert Care', desc: 'Each item is inspected and cleaned by specialists using eco-certified processes.' },
